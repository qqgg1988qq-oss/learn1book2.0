---
name: text-humanizer-zh
description: "去除文本中的AI痕迹，让表达更自然、贴近真人写作。当要编辑或审阅内容时使用。弱化AI写作特征，包括：夸张或象征性表达、宣传式语气、浅层分析句式、明确归因、控制破折号和套路化三段式表达，替换典型AI用词，并精简冗余用词，使整体更流畅可信。"
license: MIT
allowed-tools:
  - Read
  - Write
